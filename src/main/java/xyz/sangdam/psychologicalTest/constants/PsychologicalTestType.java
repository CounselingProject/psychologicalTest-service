...
public enum PsychologicalTestType {
    ...
    public static List<String[]> getList() {
        return List.of(new String[] {COMPULSION.name(), COMPULSION.title , "강박증은 반복적인 생각과 행동으로 일상에 영향을 줄 수 있습니다. 자가진단을 통해 자신의 강박적 증상을 점검해 보세요.", "강박증 자가진단 시작하기"},
                ...
                new String[] { STRESS.name(), STRESS.title, "스트레스는 신체적/정신적 건강에 큰 영향을 미칠 수 있습니다. 자가진단을 통해 현재의 스트레스 수준을 알아보세요.", "스트레스 자가진단 시작하기"},
                ...
                new String[] { EATING_DISORDER.name(), EATING_DISORDER.title, "섭식장애는 음식과 체중에 대한 부정적인 생각/행동을 포함합니다. 자가진단을 통해 식습관과 심리적 상태를 알아보세요.", "섭식장애 자가진단 시작하기" });
    }
